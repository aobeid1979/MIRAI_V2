        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="hidden md:flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="flex space-x-2 ml-4">
              <Link href="/">
                <div className="text-white hover:text-purple-500 hover:text-white rounded-md px-3 py-2 cursor-pointer">
                  Home
                </div>
              </Link>
              <Link href="/">
                <div className="text-white hover:text-black hover:text-white rounded-md px-3 py-2 cursor-pointer">
                  About
                </div>
              </Link>
              <Link href="/search">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col">
              <Link href="/">
                <div className="text-white px-2 py-4 hover:text-black cursor-pointer">
                  Home
                </div>
              </Link>
              <Link href="/search">
